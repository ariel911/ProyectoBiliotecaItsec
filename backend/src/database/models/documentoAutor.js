...
module.exports = (sequelize, DataTypes) => {
  ...
  let DocumentoAutor= sequelize.define('documento_autor', { // defino el modelo de la tabla persona
    id: {
  ...
  DocumentoAutor.associate = models => {
    // aca se relacionan las tablas de la base de datos 
    DocumentoAutor.belongsTo(models.documento)
    DocumentoAutor.belongsTo(models.autor) 
  }
