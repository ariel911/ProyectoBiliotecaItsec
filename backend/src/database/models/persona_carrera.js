...
module.exports = (sequelize, DataTypes) => {
  ...
  let PersonaCarrera= sequelize.define('persona_carrera', { // defino el modelo de la tabla persona
    id: {
  ...
  PersonaCarrera.associate = models => {
    // aca se relacionan las tablas de la base de datos 
    PersonaCarrera.belongsTo(models.persona)
    PersonaCarrera.belongsTo(models.carrera) 
  }
